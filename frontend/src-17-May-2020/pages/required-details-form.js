                    ...
                    <div className={localStorage.getItem("taxStatus") == "Individual" ? "display-check-nri fadeIn": "null" } id={user_data.resident == "1" ? "res_block" : "res_none"} id={user_data.resident == "0" ? "res_block" : ""}>
                     ...
                     <div className="row">
                        ...
                        <div className="col-md-12 md-12">
                          ...
                          <label for="not_politically" className="text-label">I am not Tax Payer of any other country except india. </label><br></br>
                  ...
                  {localStorage.getItem("jointHolder1") ?
                    <fieldset id="joint_holder_1">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4 mb-4">
                          <span className="has-float-label">
                            <input className="form-control input-text" id="holder_phon_1" type="holder_phon_1" maxLength="10" name="holder_phon_1" placeholder="Enter Mobile No" onKeyUp={this.valid} />
                  ...
                  {localStorage.getItem("jointHolder2") ?
                    <fieldset id="joint_holder_2">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4 mb-4">
                          <span className="has-float-label">
                            <input className="form-control input-text" id="holder_phon_2" type="holder_phon_2"  maxLength="10" name="holder_phon_2" placeholder="Enter Mobile No" onKeyUp={this.valid2} />
