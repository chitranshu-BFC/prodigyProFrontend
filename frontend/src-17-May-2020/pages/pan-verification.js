...
class Pan_Verification extends React.Component {
    ...
    submitForm(e) {
        ...
        $(".check_btn").html('Loading...');
          $("#overlay").css('display','block');
        Axios.post("/prodigypro/api/existingPanKyc", user_data)
        .then((resss) => {
        console.log("hh",resss.data.data)
            if(resss.data.data.status==200){
                ...
                if(fourthChar=="P"){
                    ...
                    $(".check_btn").html('Loading...');
                    Axios.post("/prodigypro/api/pen_verify", userPan)
                    .then((response) => {
                            //console.log("hh");
                            ...
                            if ((this.state.IsEKYCVerified == "Y") && (this.state.IsKYCUnderprocess=="N")) {
                                ...
                                Axios.post("/prodigypro/api/getIINStatus", userdata)
                                .then((res) => {
                                          $("#overlay").css('display','none');
                                        ...
                                        if (userStatus.length > 0) {
                                            ...
                                            for (var i = 0; i < userStatus.length; i++) {
                                                ...
                                                Axios.post("/prodigypro/api/GETIINDETAILS", userIIN)
                                                .then((resIIN) => {
                    ...
                    .then((response) => {
                        ...
                        if (this.state.nonIndKyc == "Y") {
                            Axios.post("/prodigypro/api/isPANexist", userPan)
                            .then((response) => {
                                Axios.post("/prodigypro/api/getIINStatus", userPan)
                                .then((res) => {
                                      $("#overlay").css('display','none');
                                    $(".check_btn").html('Check Now');
                                    ...
                                    if((iin==200) && (wms==200)){
                                        ...
                                        for (var i = 0; i < userStatus.length; i++) {
                                            const userIIN = { iin: userStatus[i].CUSTOMER_ID, email: email };
                                            Axios.post("/prodigypro/api/GETIINDETAILSWMS", userIIN)
                                            .then((resIIN) => {
                                                    this.setState({pageLink:"/prodigypro/dashboard"})
                                                    let dd = resIIN.data.data.data;
                                                    $(".check_btn").html('Check Now');
    ...
    render() {
        ...
        if(this.state.checkan){
            massage = < div className="alert alert-danger mt-5"
            role="alert" >
        ...
        if(case_3=="1"){
            massage = < div className="alert alert-danger mt-3"
            role="alert" >
            <div className="pb-2" >
                <span className="para" >
        ...
        if (isLoggedIn == "Y" && iinLengthdata == 0) {
            hadding = <h2 className="" > Welcome {this.state.NameAsPerPAN}! </h2>;
            massage = <div className="alert alert-success mt-3 congrats-msg"
                role="alert" >
                < h4 className="alert-heading" > Congrats {this.state.NameAsPerPAN}! </h4> <div className="pb-2"> {
                    /* <span className="para">
                        ...
                        <a href="javascript:void(0)"
                            ...
                            className="btn btn-success btn-sm" > Continue </a> </span> </div> </div>;
        ...
        <div id="overlay" >
            ...
            <br/><b className="text-danger">Please Wait...</b>
                ...
                <div className="container-fluid m-0 p-0" >
                    <div className="col-12 bg-theme welcome-div-first" > </div> < div className="col-12 welcome-div-second" > </div> <div className="col-8 offset-md-2 welcome-div-upper" >
                        <div className="col-12 text-center content-center" > {hadding}

                            <img className="" src="assets/images/welcome.png" />
                            <p className="pt-2" > We are eager to get you going. Let’s start by checking
                                if you are KYC compliant. Just fill in your PAN in the box below </p> </div> <div className="col-8 offset-md-3 text-center pt-2" >
                            <spen className="text-danger pull-left" > {this.state.Fieldtext} </spen>

                            <form action="#"
                                method="Post"
                                className="form-inline pan-form"
                                ...
                                <span className="has-float-label" >
                                    ...
                                    <label
                                        for="pan"
                                        className="text-label" > Enter PAN <span className="text-danger">*</span> </label> </span>

                                <div className="ml-4" >
                                    <button className="btn-theme-1 btn-theme-effect btn-color-green"
                                        id="btnFetch" >
                                        <span class="button-text check_btn" > Check Now </span> <span class="round" > < i class="fa fa-chevron-right" > </i></span >
                                    </button>
                        ...
                        { /* if visiter have existing IIN. */} <div className="existing-iin" >
                            ...
                            <a href={this.state.pageLink!=''?this.state.pageLink:null}
                                class="btn-theme-1 btn-theme-effect pull-right btn-color-green pp" >
                        ...
                        { /* if visiter have no existing IIN. */} <div className="join-holder" >
                            <div className="alert alert-info mt-5"
                                ...
                                <span className="has-float-label mb-4" >
                                    <select className="form-control input-text"
                                        id="tax" >
                                        <option > Individual </option> <option > NRI </option> </select> <label
                                            for="tax"
                            ...
                            {holder_msg} 
                            <a href="javascript:void(0);"
                                class="btn-theme-1 btn-theme-effect pull-right btn-color-green" onClick={this.getTaxStatus} >
                                <span class="button-text" > Proceed </span> <span class="round" > < i class="fa fa-chevron-right" > </i></span >
                            </a> {
