...
userProfile = e => { 
  ...
  this.state.userList.map(value => {
    if(value.id==userPro_id){
      ...
      this.setState({userSchemeList:{ iin:value.customer_id,investor_name:value.investor_name,amc:value.amc}})
      ...
      if(this.handlevalidation_3(dataInfo)==0){
        ...
        .then((response) => {
          ...
          if(response.data.data.status==400){
            ...
            if(response.data.data.data[0].Paymentlink){
              this.setState({Paymentlink: response.data.data.data[0].Paymentlink})
            }else{
              if(paytype=='M'){
                this.setState({orderMsg: "Payment link has been sent on your registered mail id and RMN.The Link shall remain active for the next 48 hours. Kindly authorize."})
              }else{
                this.setState({orderMsg: "Payment link has been sent on your registered mail id and RMN.The Link shall remain active for the next 48 hours."})
              }
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-xl-4 col-lg-4 mb-4">
                    <span className="has-float-label">
                      <select className="form-control input-text" onChange={this.useAMC}  name ="AMCId" id="AMCId" data-live-search="true">
                      <option value="">Select</option>
                      {this.state.amcList?
                ...
                <div className="row">
                  <div className="col-xl-4 col-lg-4 mb-4">
                    ...
                    <label htmlFor="dividend" className="text-label">IDCW</label>    
                    <br></br>  <small className="text-danger pull-left">{this.state.gw_err}</small>                                    
                  </div>
                  <div className="col-xl-4 col-lg-4 mb-4">
                    <span className="has-float-label">
                      <select className="form-control input-text" data-live-search="true" name="scheme" id="scheme" onChange={this.getschemedata}>
                      <option value="">Select</option>
                      ...
                      <label htmlFor="profile" className="text-label">Select Scheme</label>
                    </span>
                ...
                <div className="row">
                  <div className="col-xl-4 col-lg-4 mb-4" id="paymentMode_div"> 
                    <span className="has-float-label">
                      ...
                      <label htmlFor="payment_mode" className="text-label">Select Payment Mode</label>
                    </span>
                  ...
                  <div className="col-xl-4 col-lg-4 mb-4" id="bankNameDiv">
                    <span className="has-float-label">
                      ...
                      <label htmlFor="bank" className="text-label">Select Bank</label>
                    </span>
