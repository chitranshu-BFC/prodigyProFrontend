    ...
    render(){
        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className=" my-auto">
                ...
                <a href="/prodigypro/dashboard/simply-sip" className="btn btn-sm btn-danger shadow-sm mr-2">
                ...
                <a href="/prodigypro/dashboard/simply-save" className="btn btn-sm btn-danger shadow-sm">
                  <div className="d-flex">
                  <div className="img-contain-btn mr-2">
