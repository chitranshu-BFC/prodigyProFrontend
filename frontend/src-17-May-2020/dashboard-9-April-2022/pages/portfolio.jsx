        ...
        if (this.state.uniquetype) {
            ...
            for (var i = 0; i < this.state.uniquetype.length; i++) {
                                ...
                                <div className="d-flex">
                                    <div className="">
                                        <div className="icon-contain  mr-2" data-toggle="tooltip" data-placement="top" title="Additional Purchase">
                                            <a href="javascript:void(0);" onClick={this.add_purchase.bind(this, item.folio, item.isin, item.scheme)} >
                                    ...
                                    <div className="border-left">
                                        <div className="icon-contain ml-2 mr-2" data-toggle="tooltip" data-placement="top" title="SIP">
                                            <a href="javascript:void(0);" onClick={this.sip.bind(this, item.folio, item.isin, item.scheme)}>
                                    ...
                                    <div className="border-left">
                                        <div className="icon-contain ml-2 mr-2" data-toggle="tooltip" data-placement="top" title="Switch">
                                            <a href="javascript:void(0);" onClick={this.switch.bind(this, item.folio, item.isin, item.scheme)}>
                                    ...
                                    <div className="border-left">
                                        <div className="icon-contain ml-2" data-toggle="tooltip" data-placement="top" title="Redemption">
                                            <a href="javascript:void(0);" onClick={this.redemption.bind(this, item.folio, item.isin, item.scheme)} >
                ...
                lastRow = <tr>
                    ...
                    <th className="bg-light text-success"></th>
                    <th className="bg-light text-success">{total_mkt_val.toFixed(0)}.00</th>
                    {/*<th className="bg-light text-success"></th>*/}
                                                    ...
                                                    <table className="table table-hover table-bordered">
                                                        ...
                                                        <tfoot className="bg-primary">
                                                            <tr>
                                                                ...
                                                                <th scope="col"></th>
                                                                <th scope="col"></th>
                                                                <th scope="col" className="text-white">{this.state.userTotalVal ? this.state.userTotalVal.tot_cost : null}</th>
                                                                <th scope="col" className="text-white"></th>
                                                                <th scope="col" className="text-white">{this.state.userTotalVal ? this.state.userTotalVal.tot_mkt_value : null}</th>
                                                                {/*<th scope="col" className="text-white"></th>*/}
                                                                <th scope="col" className="text-white">{this.state.userTotalVal ? this.state.userTotalVal.tot_gain : null}</th>
                                                                <th scope="col" className="text-white"></th>
                                                                <th scope="col" className="text-white"></th>
                                                                <th scope="col" className="text-white">{this.state.userTotalVal ? this.state.userTotalVal.tot_cagr : null}</th>
                                                                <th scope="col" className="text-white"></th>
