                            ...
                            <div className="card shadow">
                                ...
                                <div className="card-body" id="prod_div">
                                    ...
                                    <div className="col-12 mt-4 text-right">
                                        ...
                                        : <a className="btn btn-danger shadow-sm text-color" onClick={this.iinNull.bind()}>Continue</a>}                                 
                                    </div>
                                </div>
                            </div>
                        </div>
 ...
 <div className="modal fade" id="sip_purchase" tabIndex={-1} role="dialog" aria-labelledby="sipTitle" aria-hidden="true">
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <a type="button" className="btn btn-danger shadow-sm" href="javascript:void(0);" onClick={this.state.userIin?this.cart.bind():this.iinNull.bind()} >Continue</a>
              </div>
            </div>
          </div>
        </div>
