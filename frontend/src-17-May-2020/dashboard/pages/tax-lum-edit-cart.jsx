...
class Tax_lum_Edit_Cart extends React.Component{
  constructor(){
    super();
    this.state = {
      users: []
  ...
  this.state.userScheme.map((value, key) => {
    ...
    render(){
        ...
        if (this.state.Items!='') {
          ...
          return <Redirect to='/dashboard/tax-lum-purchase' />
        }
                         ...
                         <div className="col-xl-12 col-lg-12 mb-3">
                          ...
                          {this.state.userSchemeList ?
                                ...
                                <div className="card shadow ">
                                    ...
                                    {/* <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 className="m-0 text-defult">SIP Date : {item.sip_date}</h6>
                                    </div> */}
                                </div>
...
export default Tax_lum_Edit_Cart
