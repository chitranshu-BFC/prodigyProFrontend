...
class Profile extends React.Component {
  ...
  onFileChange = event => {
    ...
    Axios.post("/prodigypro/api/profileImg",formData ,{ headers: {'Content-Type': 'multipart/form-data' }})
    .then((response) => {
                        ...
                        <div className="col-12">
                          ...
                          {this.state.userProfile ?
                            ...
                            <div className="col-md-6 offset-md-3 shadow p-3">
                              ...
                              <div className="row">
                                <div className="col-md-7">
                                  <label>Invester Identification Number (IIN)</label>
                                </div>
                                <div className="col-md-5 text-alignment font-weight-bold">
                              ...
                              <div className="row">
                                ...
                                <div className="col-md-5 text-alignment font-weight-bold">
                                  <p>{this.state.userProfile.date_of_birth}</p>
                                </div>
                              </div>
                            </div>
