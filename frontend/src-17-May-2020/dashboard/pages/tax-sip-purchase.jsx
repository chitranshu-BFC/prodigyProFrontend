...
class Tax_sip_Purchase extends React.Component{
    constructor(){
        super();
        this.state = {
          users: []
                            ...
                            <div className="card-header py-2 d-flex flex-row align-items-center justify-content-between">
                                <h6 className="m-0 font-weight-bold text-danger"></h6>
                                    <div className="dropdown no-arrow">
                                          <a className="btn btn-danger btn-sm shadow-sm" href="tax-sip-edit-cart">
...
export default Tax_sip_Purchase
