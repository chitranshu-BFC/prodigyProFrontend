    ...
    return (
      <>
        ...
        <div className="container-fluid">
          <div className="col-md-10 offset-md-1 div-overlay">
                  ...
                  <fieldset id="personal_data">
                    <div className="row " >
                      <div className="col-md-4 mb-4">
                        ...
                        <div className="text-center py-2 my-5" role="alert">
                        <img className="img-fluid" src="assets/images/resume2.png" /><br/>
                          <span className="para font-weight-bold">Primary Holder's Details :</span>
                    ...
                    <div className={localStorage.getItem("taxStatus") == "NRI" ? "display-check-ind fadeIn": "null" } id={user_data.resident == "1" ? "res_block" : ""}  >
                      <div className="row">
                        <div className="col-md-12">
                          <div className="alert alert-info my-5 text-center py-2" role="alert">
                    ...
                    <div className={localStorage.getItem("taxStatus") == "Individual" ? "display-check-nri fadeIn": "null" } id={user_data.resident == "1" ? "res_block" : "res_none"} id={user_data.resident == "0" ? "res_block" : ""}>
                      <div className="row">
                        <div className="col-md-12">
                          <div className="alert alert-danger my-5 text-center py-2" role="alert">
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          <div className="alert alert-info my-5 py-2" role="alert">
                     ...
                     <div className="row py-4">
                        <div className="col-md-12 md-12 text-left">
                          ...
                          <label for="tax_payer" className="text-label text-dark">I here by declare that i am not a politically exposed person.</label>
                         
                        </div>
                        <div className="col-md-12 md-12 text-left">
                          <input id="not_politically" type="checkbox" name="not_politically_N" value="1" onKeyUp={this.onChange} />&nbsp;&nbsp;
                          <label for="not_politically" className="text-label text-dark">I am not Tax Payer of any other country except india. </label><br></br>
                          <small className="text-danger">{this.state.not_politically_err_n}</small>
                        </div>
                      </div>

                         <Link to="/prodigypro/required-document-info-yes" class="btn-theme-1 btn-theme-effect action-button pull-left btn-color-red">
                    ...
                    <fieldset id="joint_holder_1">
                      <div className="row">
                        <div className="col-md-12 mb-4">
                          <div className="alert alert-danger my-5 py-2" role="alert">
...
authorization link for all the holder(s) sent on respective mail id(s)
                    ...
                    <a href="https://bfccapital.com/prodigypro/dashboard/" class="btn-theme-1 btn-theme-effect pull-right btn-color-green">
